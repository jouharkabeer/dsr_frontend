      ...
      renderCell: (params) => (
        <>
          ...
          <Button
            ...
            onClick={() => toggleTimberMaterialStatus(params.row.id, params.row.is_active ? 'disable' : 'enable')}
          >
        ...
        <div className="p-4 flex-grow-1 overflow-auto" style={{ maxHeight: '100%', backgroundColor: '#f8f9fa' }}>
          <Row className="mb-3 align-items-center">
            ...
            <Col className="text-end">
              <Button onClick={() => handleShowModal()} variant="primary">+ Add Timber Material</Button>
            </Col>
          </Row>
